...
class WallClock : public WidgetWithBackground 
{
    ...
    Q_PROPERTY (QFont logoFont   READ logoFont   WRITE setLogoFont)
    ...
    Q_PROPERTY(int logoOffset   READ logoOffset   WRITE setLogoOffset)
    ...
    Q_PROPERTY(QColor logoColor   READ logoColor   WRITE setLogoColor)
...
public:
    ...
    QFont logoFont() const    { return m_LogoFont;  }
    ...
    void setLogoFont  (QFont f) {       m_LogoFont   = f; updateWithBackground();}
    ...
    int      logoOffset() const { return m_LogoOffset; }
    ...
    void  setLogoOffset (int i)  {        m_LogoOffset  = i; updateWithBackground();}
    ...
    QColor    logoColor()  const { return m_LogoColor; }
    ...
    void   setLogoColor(QColor c) {        m_LogoColor = c;  updateWithBackground();}
